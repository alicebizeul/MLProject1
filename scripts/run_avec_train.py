...
ss0_tX, ss0_y, median0 = feature_processing (ss0_tX, ss0_y, 'median', replace_feature = True, suppr_outliers = True, threshold = 3, ref_median=[])
ss1_tX, ss1_y, median1 = feature_processing (ss1_tX, ss1_y, 'median', replace_feature = True, suppr_outliers = True, threshold = 3, ref_median=[])
ss2_tX, ss2_y, median2 = feature_processing (ss2_tX, ss2_y, 'median', replace_feature = True, suppr_outliers = True, threshold = 3, ref_median=[])
ss3_tX, ss3_y, median3 = feature_processing (ss3_tX, ss3_y, 'median', replace_feature = True, suppr_outliers = True, threshold = 3, ref_median=[])
...
#final_degree = [12,12,14,12] 
#lambdas = [0.0005,0.01,0.001,0.0015]
